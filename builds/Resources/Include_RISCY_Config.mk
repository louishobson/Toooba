...
DATA_PREFETCHER_LOCATION ?= LL
DATA_PREFETCHER_TYPE ?= SPP
...
ifeq (,$(filter $(DATA_PREFETCHER_TYPE),MARKOV MARKOV_ON_HIT MARKOV_ON_HIT_2 BLOCK STRIDE STRIDE_ADAPTIVE ALL_IN_CAP CHERI_STRIDE SPP))
