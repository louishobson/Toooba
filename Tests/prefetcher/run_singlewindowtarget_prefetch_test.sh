...
bsc -bdir $BUILD_DIR -show-range-conflict -simdir $BUILD_DIR -sim -g mkSingleWindowTargetPrefetcherTest ./../../src_Testbench/Unit/Prefetcher_test.bsv && bsc -bdir $BUILD_DIR -simdir $BUILD_DIR -sim -e mkSingleWindowTargetPrefetcherTest -o prefetch_singlewindowtarget_test && \
./prefetch_singlewindowtarget_test && \
rm ./prefetch_singlewindowtarget_test*
