...
bsc -bdir $BUILD_DIR -show-range-conflict -simdir $BUILD_DIR -sim -g mkCapBitmapPrefetcherTest1 ./../../src_Testbench/Unit/CheriPrefetcher_test.bsv && \
bsc -bdir $BUILD_DIR -simdir $BUILD_DIR -sim -e mkCapBitmapPrefetcherTest1 -o prefetch_capbitmap_test1 && \ 
