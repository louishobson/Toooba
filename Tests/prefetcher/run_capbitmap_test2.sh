...
bsc -bdir $BUILD_DIR -show-range-conflict -simdir $BUILD_DIR -sim -g mkCapBitmapPrefetcherTest2 ./../../src_Testbench/Unit/CheriPrefetcher_test.bsv && \
bsc -bdir $BUILD_DIR -simdir $BUILD_DIR -sim -e mkCapBitmapPrefetcherTest2 -o prefetch_capbitmap_test2 && \ 
./prefetch_capbitmap_test2  && \
